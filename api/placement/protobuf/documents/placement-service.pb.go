...
type UpdatePlacementDocument struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdatePlacementDocument) Reset() {
	*x = UpdatePlacementDocument{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdatePlacementDocument) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdatePlacementDocument) ProtoMessage() {}

func (x *UpdatePlacementDocument) ProtoReflect() protoreflect.Message {
	mi := &file_proto_placement_service_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdatePlacementDocument.ProtoReflect.Descriptor instead.
func (*UpdatePlacementDocument) Descriptor() ([]byte, []int) {
	return file_proto_placement_service_proto_rawDescGZIP(), []int{5}
}

func (x *UpdatePlacementDocument) GetChannel() string {
	if x != nil {
		return x.Channel
	}
	return ""
...
func (x *UpdatePlacementDocument) GetReffNo() string {
	if x != nil {
		return x.ReffNo
	}
	return ""
...
func (x *UpdatePlacementDocument) GetSignType() string {
	if x != nil {
		return x.SignType
	}
	return ""
...
func (x *UpdatePlacementDocument) GetDocFlow() string {
	if x != nil {
		return x.DocFlow
	}
	return ""
...
func (x *UpdatePlacementDocument) GetDocCategory() string {
	if x != nil {
		return x.DocCategory
	}
	return ""
...
func (x *UpdatePlacementDocument) GetDocTitle() string {
	if x != nil {
		return x.DocTitle
	}
	return ""
...
func (x *UpdatePlacementDocument) GetDocStatus() string {
	if x != nil {
		return x.DocStatus
	}
	return ""
...
func (x *UpdatePlacementDocument) GetUploader() string {
	if x != nil {
		return x.Uploader
	}
	return ""
...
func (x *UpdatePlacementDocument) GetUploaderPrivyId() string {
	if x != nil {
		return x.UploaderPrivyId
	}
	return ""
...
func (x *UpdatePlacementDocument) GetESign() string {
	if x != nil {
		return x.ESign
	}
	return ""
...
func (x *UpdatePlacementDocument) GetEMaterai() string {
	if x != nil {
		return x.EMaterai
	}
	return ""
...
func (x *UpdatePlacementDocument) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
type RevokePlacementDocument struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RevokePlacementDocument) Reset() {
	*x = RevokePlacementDocument{}
	if protoimpl.UnsafeEnabled {
...
func (x *RevokePlacementDocument) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RevokePlacementDocument) ProtoMessage() {}

func (x *RevokePlacementDocument) ProtoReflect() protoreflect.Message {
	mi := &file_proto_placement_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RevokePlacementDocument.ProtoReflect.Descriptor instead.
func (*RevokePlacementDocument) Descriptor() ([]byte, []int) {
	return file_proto_placement_service_proto_rawDescGZIP(), []int{6}
}

func (x *RevokePlacementDocument) GetReffNo() string {
	if x != nil {
		return x.ReffNo
	}
	return ""
...
func (x *RevokePlacementDocument) GetDocStatus() string {
	if x != nil {
		return x.DocStatus
	}
	return ""
...
type DetailRevokedDocument struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DetailRevokedDocument) Reset() {
	*x = DetailRevokedDocument{}
	if protoimpl.UnsafeEnabled {
...
func (x *DetailRevokedDocument) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DetailRevokedDocument) ProtoMessage() {}

func (x *DetailRevokedDocument) ProtoReflect() protoreflect.Message {
	mi := &file_proto_placement_service_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DetailRevokedDocument.ProtoReflect.Descriptor instead.
func (*DetailRevokedDocument) Descriptor() ([]byte, []int) {
	return file_proto_placement_service_proto_rawDescGZIP(), []int{7}
}

func (x *DetailRevokedDocument) GetReffNo() string {
	if x != nil {
		return x.ReffNo
	}
	return ""
...
var file_proto_placement_service_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x74, 0x61, 0x22, 0xfe, 0x02, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50,
	...
	,
	...
	,
...
var file_proto_placement_service_proto_goTypes = []interface{}{
	...
	(*UpdatePlacementDocument)(nil),       // 5: placementpb.UpdatePlacementDocument
	(*RevokePlacementDocument)(nil),       // 6: placementpb.RevokePlacementDocument
	(*DetailRevokedDocument)(nil),         // 7: placementpb.DetailRevokedDocument
}
var file_proto_placement_service_proto_depIdxs = []int32{
	...
	6, // 4: placementpb.PlacementService.ServeRevokePlacementDocument:input_type -> placementpb.RevokePlacementDocument
	1, // 5: placementpb.PlacementService.ServeListRevokedPlacementDocument:input_type -> placementpb.PlacementDocParameterRequest
	5, // 6: placementpb.PlacementService.ServeUpdatePlacementDocument:input_type -> placementpb.UpdatePlacementDocument
...
func file_proto_placement_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_placement_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdatePlacementDocument); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_placement_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RevokePlacementDocument); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_placement_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DetailRevokedDocument); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
